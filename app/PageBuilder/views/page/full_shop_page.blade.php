...
<div class="shop-grid-area-wrapper left-sidebar top-product-wrapper" data-padding-top="{{ $settings['padding_top'] }}"  data-padding-bottom="{{ $settings['padding_bottom'] }}">
            ...
            <div class="col-lg-12">
                ...
                <div class="grid-wrapper">
                    @foreach($all_products as $product)
                        @if($item_style == 'grid')
                            <div class="col-6 col-sm-6 col-md-6 {{ $item_width ?? 'col-lg-3' }}">
                                <x-frontend.product.product-card-03 :product="$product" />
                            </div>
                        @elseif($item_style == 'full')
                            <div class="single-grid">
                                <x-frontend.product.product-card-05 :product="$product" />
                            </div>
                        @else
