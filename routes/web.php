...
Route::prefix('admin-home')->middleware(['setlang:backend', 'adminglobalVariable'])->group(function () {
     ...
     //Upgrade Database
    Route::get('/database-upgrade', 'Admin\GeneralSettingsController@database_upgrade')->name('admin.general.database.upgrade');
    Route::post('/database-upgrade', 'Admin\GeneralSettingsController@database_upgrade_post');
    ...
    Route::prefix('mobile-slider')->as("admin.mobile.slider.")->group(function () {
        Route::controller("Admin\MobileSliderController")->group(function (){
    ...
    // Route::prefix('mobile-campaigns')->as("admin.mobile.slider.two.")->group(function () {
    //     Route::controller("MobileCampaignController")->group(function (){
    //         Route::get('list', "index")->name('all');
    //         Route::get('new', "create")->name('create');
    //         Route::post('new', "store");
    ...
    Route::prefix('mobile-featured-product')->as("admin.featured.product.")->group(function () {
        Route::controller("MobileFeaturedProductController")->group(function (){
            Route::get('list', "index")->name('all');
            Route::get('new', "create")->name('create');
            Route::post('new', "store");
            Route::get('update/{id}', "edit")->name("edit");
    ...
    Route::prefix('mobile-settings')->as("admin.mobile.settings.")->group(function () {
        Route::controller('AdminMobileController')->group(function (){
    ...
    Route::group(['prefix' => 'state', 'namespace' => 'Country', 'as' => 'admin.state.'], function () {
        ...
        Route::post('mutliple-country-state', 'StateController@getMultipleStateByCountry')->name('by.multiple.country');
    });
    ...
    Route::prefix('tax')->namespace('Tax')->group(function () {
        ...
        Route::group(['prefix' => 'state', 'as' => 'admin.tax.state.'], function () {
            ...
            // Route::get('state-by-country', 'StateTaxController@state_by_country')->name('by.country');
        });
    });
    ...
    Route::group(['prefix' => 'page-settings', 'as' => 'admin.page.settings.'], function () {
        ...
        Route::get('product-details-page', 'Admin\ModulePageSettingsController@productDetailPage')->name('product.detail.page');
        Route::post('product-details-page', 'Admin\ModulePageSettingsController@storeProductDetailPage');
    });
    ...
    Route::group(['prefix' => 'appearance-settings/topbar', 'namespace' => 'Admin'], function () {
        ...
        Route::post('/select-menu', "TopBarController@selectTopBarMenu")->name('admin.topbar.select.menu');
    ...
    Route::group(['prefix' => 'general-settings', 'namespace' => 'Admin'], function () {
        ...
        //Reading
//        Route::get('/others', 'GeneralSettingsController@others')->name('admin.general.others');
//        Route::post('/others', 'GeneralSettingsController@update_others');
        ...
        Route::get('/navbar-category-dropdown', 'GeneralSettingsController@navbar_category_dropdown')->name('admin.general.navbar.category.dropdown');
        Route::post('/navbar-category-dropdown', 'GeneralSettingsController@update_navbar_category_dropdown');
...
Route::group(['middleware' => ['setlang:backend', 'auth:admin'], 'prefix' => 'admin-home', 'namespace' => 'Admin'], function () {
    ...
    Route::post('page-builder/update-order', 'PageBuilderController@update_addon_order')->name('admin.page.builder.update.addon.order');
    Route::post('page-builder/get-admin-markup', 'PageBuilderController@get_admin_panel_addon_markup')->name('admin.page.builder.get.addon.markup');
});
