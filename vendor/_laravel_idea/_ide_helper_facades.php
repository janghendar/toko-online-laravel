...
namespace Illuminate\Support\Facades {
     ...
     * @see \Illuminate\Http\Request::sanitize_html
     * @method static string sanitize_html($value)
     * @see \Illuminate\Http\Request::custom_html
...
namespace Srmklive\PayPal\Facades {
    ...
    /**
     * @see \Srmklive\PayPal\PayPalFacadeAccessor::getProvider
     * @method static \Srmklive\PayPal\Services\PayPal getProvider()
     * @see \Srmklive\PayPal\PayPalFacadeAccessor::setProvider
     * @method static \Srmklive\PayPal\Services\PayPal setProvider()
     */
    class PayPal {}
}
...
namespace Xgenious\Paymentgateway\Facades {
    ...
    /**
     * @see \Xgenious\Paymentgateway\Base\GlobalCurrency::script_currency_list
     * @method static string[] script_currency_list()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::flutterwave
     * @method static \Xgenious\Paymentgateway\Base\Gateways\FlutterwavePay flutterwave()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::paystack
     * @method static \Xgenious\Paymentgateway\Base\Gateways\PaystackPay paystack()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::cashfree
     * @method static \Xgenious\Paymentgateway\Base\Gateways\CashFreePay cashfree()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::midtrans
     * @method static \Xgenious\Paymentgateway\Base\Gateways\MidtransPay midtrans()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::mollie
     * @method static \Xgenious\Paymentgateway\Base\Gateways\MolliePay mollie()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::marcadopago
     * @method static \Xgenious\Paymentgateway\Base\Gateways\MarcadoPagoPay marcadopago()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::stripe
     * @method static \Xgenious\Paymentgateway\Base\Gateways\StripePay stripe()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::razorpay
     * @method static \Xgenious\Paymentgateway\Base\Gateways\RazorPay razorpay()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::paytm
     * @method static \Xgenious\Paymentgateway\Base\Gateways\PaytmPay paytm()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::instamojo
     * @method static \Xgenious\Paymentgateway\Base\Gateways\InstamojoPay instamojo()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::payfast
     * @method static \Xgenious\Paymentgateway\Base\Gateways\PayFastPay payfast()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::payumoney
     * @method static \Xgenious\Paymentgateway\Base\Gateways\PayUmoneyPay payumoney()
     * @see \Xgenious\Paymentgateway\Base\PaymentGatewayHelpers::paypal
     * @method static \Xgenious\Paymentgateway\Base\Gateways\PaypalPay paypal()
     */
...
namespace {
    ...
    class Requests extends Illuminate\Support\Facades\Request {}
