                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            <h4 class="header-title"><?php echo e(__('Edit Category Menu')); ?></h4>
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('admin.category.menu.settings')); ?>" class="btn btn-primary btn-xs"><?php echo e(__('All Category Menus')); ?></a>
                            </div>
                        </div>
                        <form action="<?php echo e(route('admin.category.menu.update',$page_post->id)); ?>" id="menu_update_form" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <div class="menu-left-side-content">
                                        <h3 class="title"><?php echo e(__('Add Category menu items')); ?></h3>
                                        <div class="accordion accordion-wrapper" id="add_menu_item_accordion">
                                            <?php echo render_product_category_list($page_post->lang ?? ''); ?>

                                            <?php echo render_product_category_mega_menu_list($page_post->lang ?? ''); ?>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="custom-links-content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <p>If you want to use root url of your site <br> For that use this <b>@url</b></p><br>
                                                        ...
                                                        <div class="form-group">
                                                            <button type="button" id="add_custom_links"
                                                                    class="btn btn-primary btn-xs mt-4 pr-4 pl-4"><?php echo e(__('Add To Category Menu')); ?></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="dd" id="nestable">
                                                        <ol class="dd-list">
                                                            ...
                                                            <?php if(!empty($page_post->content)): ?>
                                                                <?php echo render_draggable_category_menu($page_post->id); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.add_mega_menu_to_menu',function (e) {
                ...
                $.each(allList,function (index,value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('admin.mega.category.menu.item.select.markup')); ?>",
                        data:{
            ...
            $('body').on('change','select[name="sub_cat_items_id"]',function (e) {
                e.preventDefault();
                var el = $(this);
                var item_id = $(this).val();
                if(item_id != '' ){
                    el.parent().parent().attr('data-sub_cat_items_id',item_id);
                }else{
                    el.parent().parent().removeAttr('data-sub_cat_items_id');
                }
            });
        ...
        $(document).on("change",".product_mega_menu_category_selection",function (){
            let data = new FormData();
            data.append("category_id",$(this).val());
            data.append("_token","<?php echo e(csrf_token()); ?>");

            $.ajax({
                url: "<?php echo e(route('admin.category.menu.sub_category')); ?>",
                data: data,
                method: 'POST',
                processData: false,
                contentType: false,
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/pages/category_menu/menu-edit.blade.php ENDPATH**/ ?>