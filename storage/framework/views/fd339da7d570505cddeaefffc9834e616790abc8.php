                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="site_default_payment_gateway" class="form-control" >
                                            <?php
                                                $all_gateways = ['paypal','paytm','mollie','stripe','razorpay','flutterwave','paystack','midtrans','payfast','cashfree','instamojo','marcadopago','cash_on_delivery','manual_payment','bank_transfer','cheque_payment'];
                                            ?>
                                    ...
                                    <div class="accordion-wrapper">
                                        <div id="accordion-payment">
                                                ...
                                                <div id="paystack_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="margin-bottom-30 margin-top-20 info-paragraph">
                                                            ...
                                                            <input type="text" class="info-url" value="<?php echo e(route('frontend.products.paystack.ipn')); ?>">
                                                        </p>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="instamojo_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="instamojo_auth_token"><?php echo e(__('Instamojo Auth Token')); ?></label>
                                                            <input type="text" name="instamojo_auth_token" id="instamojo_auth_token" value="<?php echo e(get_static_option('instamojo_auth_token')); ?>" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="bank_transfer_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                data-toggle="collapse"
                                                                data-target="#bank_transfer_settings_content"
                                                                aria-expanded="false">
                                                            <span class="page-title"> <?php echo e(__('Bank Transfer Settings')); ?></span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="bank_transfer_settings_content" class="collapse"
                                                     data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="bank_transfer_gateway"><strong><?php echo e(__('Enable/Disable Bank Transfer')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="bank_transfer_gateway"
                                                                       <?php if(!empty(get_static_option('bank_transfer_gateway'))): ?> checked
                                                                       <?php endif; ?> id="bank_transfer_gateway">
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_logo"><strong><?php echo e(__('Bank Transfer Logo')); ?></strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    <?php
                                                                        $paytm_img = get_attachment_image_by_id(get_static_option('bank_transfer_preview_logo'),null,false);
                                                                        $paytm_image_btn_label = __('Upload Image');
                                                                    ?>
                                                                    <?php if(!empty($paytm_img)): ?>
                                                                        <div class="attachment-preview">
                                                                ...
                                                                <input type="hidden" id="bank_transfer_preview_logo"
                                                                       name="bank_transfer_preview_logo"
                                                                       value="<?php echo e(get_static_option('bank_transfer_preview_logo')); ?>">
                                                                <button type="button"
                                                                        class="btn btn-info media_upload_form_btn"
                                                                        data-btntitle="<?php echo e(__('Select Image')); ?>"
                                                                        data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="site_bank_transfer_name"><?php echo e(__('Bank Transfer Name')); ?></label>
                                                            <input type="text" name="site_bank_transfer_name"
                                                                   id="site_bank_transfer_name"
                                                                   value="<?php echo e(get_static_option('site_bank_transfer_name')); ?>"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_bank_transfer_description"><?php echo e(__('Bank Transfer Description')); ?></label>
                                                            <input type="hidden" name="site_bank_transfer_description" value="<?php echo e(get_static_option('site_bank_transfer_description')); ?>">
                                                            <div class="summernote" data-content='<?php echo e(get_static_option('site_bank_transfer_description')); ?>'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="cheque_payment_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                data-toggle="collapse"
                                                                data-target="#cheque_payment_settings_content"
                                                                aria-expanded="false">
                                                            <span class="page-title"> <?php echo e(__('Cheque Payment Settings')); ?></span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="cheque_payment_settings_content" class="collapse"
                                                     data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="cheque_payment_gateway"><strong><?php echo e(__('Enable/Disable Cheque Payment')); ?></strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="cheque_payment_gateway"
                                                                       <?php if(!empty(get_static_option('cheque_payment_gateway'))): ?> checked
                                                                       <?php endif; ?> id="cheque_payment_gateway">
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_logo"><strong><?php echo e(__('Cheque Payment Logo')); ?></strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    <?php
                                                                        $paytm_img = get_attachment_image_by_id(get_static_option('cheque_payment_preview_logo'),null,false);
                                                                        $paytm_image_btn_label = __('Upload Image');
                                                                    ?>
                                                                    <?php if(!empty($paytm_img)): ?>
                                                                        <div class="attachment-preview">
                                                                ...
                                                                <input type="hidden" id="cheque_payment_preview_logo"
                                                                       name="cheque_payment_preview_logo"
                                                                       value="<?php echo e(get_static_option('cheque_payment_preview_logo')); ?>">
                                                                <button type="button"
                                                                        class="btn btn-info media_upload_form_btn"
                                                                        data-btntitle="<?php echo e(__('Select Image')); ?>"
                                                                        data-modaltitle="<?php echo e(__('Upload Image')); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="site_cheque_payment_name"><?php echo e(__('Cheque Payment Name')); ?></label>
                                                            <input type="text" name="site_cheque_payment_name"
                                                                   id="site_cheque_payment_name"
                                                                   value="<?php echo e(get_static_option('site_cheque_payment_name')); ?>"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_cheque_payment_description"><?php echo e(__('Cheque Payment Description')); ?></label>
                                                            <input type="hidden" name="site_cheque_payment_description" value="<?php echo e(get_static_option('site_cheque_payment_description')); ?>">
                                                            <div class="summernote" data-content='<?php echo e(get_static_option('site_cheque_payment_description')); ?>'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/general-settings/payment-gateway.blade.php ENDPATH**/ ?>