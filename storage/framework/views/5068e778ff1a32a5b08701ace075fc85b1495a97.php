                                ...
                                <div class="media-uploader-image-info">
                                    ...
                                    <div class="img-info">
                                            ...
                                            <li class="imgalt">
                                               <div class="img-alt-wrap">
                                                   ...
                                                   <button class="btn btn-success img_alt_submit_btn">
                                                       <i class="<?php if($type === 'admin'): ?> fas fa-check <?php else: ?> las la-check <?php endif; ?>"></i>
                                                       </button>
                                               </div>
                                            </li>
                                        </ul>
                                        <a tabindex="0" style="display: none" class=" btn btn-lg btn-danger btn-sm mb-3 mr-1 media_library_image_delete_btn" data-type="<?php echo e($type); ?>" role="button">
                                            <i class="<?php if($type === 'admin'): ?> fas fa-trash <?php else: ?> las la-trash <?php endif; ?>"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
...
</div><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/components/media/markup.blade.php ENDPATH**/ ?>