            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route("admin.mobile.campaign.update")); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="form-group" id="product-list">
                                ...
                                <select id="products" name="campaign" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $campaigns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($item->id); ?>" <?php echo e($item->id == $selectedCampaign->campaign_id ? "selected" : ""); ?>><?php echo e($item->name); ?></option>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/mobile-campaign/create.blade.php ENDPATH**/ ?>