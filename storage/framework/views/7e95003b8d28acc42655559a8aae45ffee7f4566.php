            ...
            <div class="row">
                <div class="form-group form-check col-12">
                    ...
                    <label class="form-check-label label-1" for="Check1">
                        <?php echo filter_static_option_value('create_account_text', $setting_text, __('Create an Account with above details?')); ?>
        ...
        <div class="creat-account-content-wrap d-block">
            <div class="row">
                <div class="form-group col-lg-12 col-12">
                    <label for="create_account_username"><?php echo e(filter_static_option_value('create_account_username', $setting_text, __('Username'))); ?></label>
                    <input type="text" autocomplete="off" name="username" class="form-control" id="create_account_username" value="">
                </div>
                <div class="form-group col-lg-6 col-12">
                    <label for="create_account_password"><?php echo e(filter_static_option_value('create_account_password', $setting_text, __('Password'))); ?></label>
                    <input type="password" autocomplete="off" name="password" class="form-control" id="create_account_password" value="">
                </div>
                <div class="form-group col-lg-6 col-12">
                    <label for="create_account_password_confirmation"><?php echo e(filter_static_option_value('create_account_confirmed_password', $setting_text, __('Confirmed Password'))); ?></label>
...
<?php endif; ?>
<?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/cart/partials/create-account.blade.php ENDPATH**/ ?>