                                ...
                                <div class="toolbox-right">
                                    ...
                                    <div class="toolbox-item toolbox-layout">
                                        <ul class="layout-list">
                                            ...
                                            <li class="layout-item">
                                                <a href="<?php echo e(route('frontend.products.all', ['s' => 'list'])); ?>"
                    ...
                    <div class="row col-control">
                        <?php $__currentLoopData = $all_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($item_style == 'grid'): ?>
                                <div class="col-6 col-sm-6 col-md-6 <?php echo e($item_width); ?>">
                                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.frontend.product.product-card-03','data' => ['product' => $product]]); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/dynamic-redirect/product.blade.php ENDPATH**/ ?>