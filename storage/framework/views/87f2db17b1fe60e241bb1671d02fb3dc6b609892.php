                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.general.color.settings')); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="site_special_color"><?php echo e(__('Site Special Color Settings')); ?></label>
                                <input type="text" name="site_special_color" style="background-color: <?php echo e(get_static_option('site_special_color')); ?>;color: #fff;" class="form-control" value="<?php echo e(get_static_option('site_special_color')); ?>" id="site_special_color">
                                <small><?php echo e(__('you change site special color from here, it will replace website special color')); ?></small>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_form_bg_color" style="background-color: <?php echo e(get_static_option('site_form_bg_color')); ?>;color: #fff;" class="form-control" value="<?php echo e(get_static_option('site_form_bg_color')); ?>" id="site_form_bg_color">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="site_footer_bg_color" style="background-color: <?php echo e(get_static_option('site_footer_bg_color')); ?>;color: #fff;" class="form-control" value="<?php echo e(get_static_option('site_footer_bg_color')); ?>" id="site_footer_bg_color">
                                <small><?php echo e(__('you can change site paragraph color from there')); ?></small>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/general-settings/color-settings.blade.php ENDPATH**/ ?>