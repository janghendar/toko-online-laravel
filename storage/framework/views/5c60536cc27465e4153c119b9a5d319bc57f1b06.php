                            ...
                            <tbody>
                                <?php $__currentLoopData = $all_orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="alert <?php if($data->payment_status == 'pending'): ?> alert-warning <?php else: ?> alert-success <?php endif; ?> text-capitalize"><?php echo e($data->payment_status); ?></span>
                                        </td>
                                        <td>
...
<?php endif; ?>
                                            ...
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('product-order-generate-invoice')): ?>
                                                <a href="<?php echo e(route('frontend.product.invoice.generate')); ?>" data-id="<?php echo e($data->id); ?>" class="btn btn-xs btn-secondary download_invoice mb-3 mr-1" target="_blank"><?php echo e(__('Invoice')); ?></a>
                                            <?php endif; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/products/order/all.blade.php ENDPATH**/ ?>