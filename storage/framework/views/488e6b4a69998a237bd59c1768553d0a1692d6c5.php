...
<script>
    (function ($) {
        ...
        $(document).on('click', '.media_upload_modal_submit_btn', function (e) {
            ...
            if (typeof allData != 'undefined') {
                ...
                $.each(allData, function (index, value) {
                    ...
                    mainUploadBtn.parent().find('.img-wrap').append('<div class="rmv-span"><i class="<?php if($type === 'admin'): ?> fas fa-trash <?php else: ?> las la-trash <?php endif; ?>"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered"><img src="' + el.imgsrc + '"></div></div></div>');
                });
        ...
        $('body').on('click', '.media-uploader-image-list > li', function (e) {
            ...
            $('.img_alt_submit_btn').html('<i class="<?php if($type === 'admin'): ?> fas fa-check <?php else: ?> las la-check <?php endif; ?>"></i>');
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('.img_alt_submit_btn').html('<i class="<?php if($type === 'admin'): ?> fas fa-check-circle <?php else: ?>  las la-check-circle  <?php endif; ?>"></i>');
        ...
        $(document).on('click', '#loadmorewrap', function () {
            ...
            $('#loadmorewrap button').append(' <i class="<?php if($type === 'admin'): ?> fas fa-spinner fa-spin <?php else: ?> las la-spinner la-spin <?php endif; ?> "></i>');
            $.ajax({
                type: "POST",
...
<?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/components/media/js.blade.php ENDPATH**/ ?>