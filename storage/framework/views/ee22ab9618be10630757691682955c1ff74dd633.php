...
<head>
    ...
    <title><?php echo e(__('Admin Password Reset')); ?></title>
    <style>
        .mail-container {
            max-width: 650px;
            margin: 0 auto;
    ...
    <div class="logo-wrapper">
        <a href="<?php echo e(url('/')); ?>">
            ...
            <?php if(!empty($site_logo)): ?>
                <img src="<?php echo e($site_logo['img_url']); ?>" alt="<?php echo e(get_static_option('site_title')); ?>">
            <?php endif; ?>
        </a>
    </div>
...
</html><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/mail/admin-pass-reset.blade.php ENDPATH**/ ?>