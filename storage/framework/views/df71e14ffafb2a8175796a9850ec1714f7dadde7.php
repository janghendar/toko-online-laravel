            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('admin.maintains.page.settings')); ?>" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="maintain_page_title"
                                       value="<?php echo e(get_static_option('maintain_page_title')); ?>" name="maintain_page_title"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="maintain_page_description" id="maintain_page_description"
                                          ...
                                          rows="10"><?php echo e(get_static_option('maintain_page_description')); ?></textarea>
                            </div>
                            <div class="form-group">
                                <label for="maintain_page_datepicker"><?php echo e(__( 'Date')); ?></label>
                                <input type="date" class="form-control flatpickr" id="maintain_page_datepicker"
                                       value="<?php echo e(get_static_option('maintain_page_datepicker')); ?>" name="maintain_page_datepicker"
                            ...
                            <div class="form-group">
                                ...
                                <div class="media-upload-btn-wrapper">
                                                ...
                                                <div class="thumbnail">
                                                    <div class="centered">
                                                        <img class="avatar user-thumb"
                                                             src="<?php echo e($maintain_page_background_image['img_url']); ?>"
                                                             alt="">
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <button type="button" class="btn btn-info media_upload_form_btn"
                                            data-btntitle="<?php echo e(__('Select Background Image')); ?>"
                                            data-modaltitle="<?php echo e(__('Upload Background Image')); ?>" data-toggle="modal"
                                            data-target="#media_upload_modal">
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/pages/maintain-page/maintain-page.blade.php ENDPATH**/ ?>