                        ...
                        <table class="table table-default">
                            ...
                            <?php $__currentLoopData = $all_lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <ul>
                                            <li><strong><?php echo e('Name'); ?></strong> <?php echo e($data->name); ?></li>
                                            <li><strong><?php echo e('Direction'); ?></strong> <?php echo e(strtoupper($data->direction)); ?></li>
                                            <li><strong><?php echo e('Slug'); ?></strong> <?php echo e(strtoupper($data->slug)); ?></li>
                                            <li><strong><?php echo e('Status'); ?></strong> <?php echo e(strtoupper($data->status)); ?></li>
                                        </ul>
...
<?php endif; ?>
                                        ...
                                        <a href="<?php echo e(route('admin.languages.words.backend',$data->slug)); ?>"
                                           title="<?php echo e(__('Admin Panel Words')); ?>"
                                           class="btn btn-secondary btn-xs mb-3 mr-1 text-white" >
                                            <i class="ti-pencil"></i> <?php echo e(__('Admin Words')); ?>

                                        </a>
                                        <a href="<?php echo e(route('admin.languages.words.frontend',$data->slug)); ?>"
                                           title="<?php echo e(__('Frontend Words')); ?>" class="btn btn-info btn-xs mb-3 mr-1 text-white"
                                           >
                                            <i class="ti-pencil"></i> <?php echo e(__('Frontend Words')); ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/languages/index.blade.php ENDPATH**/ ?>