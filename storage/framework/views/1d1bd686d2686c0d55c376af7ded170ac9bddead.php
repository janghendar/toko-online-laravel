                            ...
                            >
                                <div class="content">
                                    ...
                                    <div class="btn-wrapper">
                                        <a href="<?php echo e(\App\traits\URL_PARSE::url($data['button_url_'][$key])); ?>" class="btn-default transparent-btn-1"><?php echo e($data['button_text_'][$key]); ?></a>
                                    </div>
                                </div>
                            </div>
...
<?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/beta/@core/app/Providers/../PageBuilder/views/header/header_slider_one.blade.php ENDPATH**/ ?>