                        ...
                        <div class="gig-chat-message-heading">
                            ...
                            <div class="gig-order-info">
                                <ul>
                                    ...
                                    <li><strong><?php echo e(__('Status:')); ?></strong> <span class="status-<?php echo e($ticket_details->status); ?>"><?php echo e(__($ticket_details->status)); ?></span>
                                    </li>
                                    <li><strong><?php echo e(__('Priority:')); ?></strong> <span class="<?php echo e($ticket_details->priority); ?>"><?php echo e(__($ticket_details->priority)); ?></span>
                                    </li>
                                    <li>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/user/dashboard/support-tickets/view.blade.php ENDPATH**/ ?>