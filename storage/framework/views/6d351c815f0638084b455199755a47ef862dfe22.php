                                                ...
                                                <div class="checkbox-color ">
                                                    <?php $__currentLoopData = $attribute['terms']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="single-checkbox-wrap attribute">
                                                            <label>
                                                                <input readonly type="radio" name="attr_<?php echo e($attribute['name']); ?>"
                                    ...
                                    <?php if($productColors->count() > 0 && current(current($productColors))): ?>
                                        <div class="value-input-area margin-top-15 color_list">
                                                <span class="input-list">
                                                    ...
                                                    <input readonly class="form--input value-size" name="color" type="text"
                                                           value="">
                        ...
                        <div class="row margin-top-90">
                            <div class="col-lg-12">
                                <div class="section-title-wrapper">
                                    ...
                                    <div class="img-box">
                                        <?php echo render_image_markup_by_attachment_id(get_static_option('related_product_image')); ?>
...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.frontend.product.product-card-03','data' => ['product' => $related_product,'model' => false]]); ?>
<?php $component->withName('frontend.product.product-card-03'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['product' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($related_product),'model' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/product/details.blade.php ENDPATH**/ ?>