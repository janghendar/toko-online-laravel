...
<?php endif; ?>
                                ...
                                <?php $__currentLoopData = $all_pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.bulk-action.td','data' => ['id' => $page->id]]); ?>
...
<?php endif; ?>
                                        ...
                                        <td>
                                            ...
                                            <?php if(isset($dynamic_page_ids[$page->id])): ?>
                                                <?php if($dynamic_page_ids[$page->id] == 'home_page'): ?>
                                                    <strong class="text-info"> - <?php echo e(__('Home Page')); ?></strong>
                                                <?php elseif($dynamic_page_ids[$page->id] == 'blog_page'): ?>
                                                    <strong class="text-info"> - <?php echo e(__('Blog Page')); ?></strong>
                                                <?php elseif($dynamic_page_ids[$page->id] == 'product_page'): ?>
                                        ...
                                        <td>
                                            <?php if(empty($dynamic_page_ids[$page->id])): ?>
                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.delete-popover','data' => ['url' => route('admin.page.delete',$page->id)]]); ?>
<?php $component->withName('delete-popover'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.page.delete',$page->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                            ...
                                            <a class="btn btn-xs btn-primary btn-sm mb-3 mr-1"
                                               href="<?php echo e(route('admin.page.edit',$page->id)); ?>">
                                                <i class="ti-pencil"></i>
                                            </a>
                                            <?php if(!empty($page->page_builder_status)): ?>
                                                <a href="<?php echo e(route('admin.dynamic.page.builder',['type' =>'dynamic-page','id' => $page->id])); ?>"
                                                   target="_blank"
                                                   class="btn btn-xs btn-secondary mb-3 mr-1"><?php echo e(__('Open Page Builder')); ?></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.bulk-action.js','data' => ['route' => route('admin.page.bulk.action')]]); ?>
<?php $component->withName('bulk-action.js'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('admin.page.bulk.action'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/pages/page/index.blade.php ENDPATH**/ ?>