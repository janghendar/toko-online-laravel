...
<?php endif; ?>
                            ...
                            <form method="POST" action="<?php echo e(route('frontend.products.track.order')); ?>">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control" id="email" placeholder="<?php echo e(__('Billing Email')); ?>">
                                </div>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/pages/track-order.blade.php ENDPATH**/ ?>