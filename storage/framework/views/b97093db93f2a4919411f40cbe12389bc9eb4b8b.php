...
<ul class="sub-menu mega-menu-inner">
    <?php $__currentLoopData = $mega_menu_items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
            $products = \Modules\Product\Entities\Product::with("campaignProduct")->whereJsonContains('sub_category_id', "$item->id")->inRandomOrder()->take(2)->get();
        ?>
                            ...
                            <div class="category-menu-product-wrap">
                                <div class="left-side">
                                    ...
                                    <?php if(!empty($campaign_percentage)): ?>
                                        <span class="badge badge-danger left-side-badge"><?php echo e(round($campaign_percentage,2)); ?>%</span>
                                    <?php endif; ?>
                                </div>
                                <div class="right-side">
                                    <h5 class="product-title">
                                        <a href="<?php echo e(route('frontend.products.single', $product->slug)); ?>" class="title-text">
                                            <?php echo e(html_entity_decode($product->title)); ?></a>
                                    </h5>
        ...
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</ul><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/beta/@core/app/Providers/../MenuBuilder/CategoryMenu/views/style_one_category_menu.blade.php ENDPATH**/ ?>