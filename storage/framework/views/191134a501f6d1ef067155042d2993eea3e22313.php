            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('user.dashboard.support.ticket.view', $data->id)); ?>"  class="btn btn-info btn-xs" target="_blank"><i class="las la-eye"></i></a>
                        </td>
                    </tr>
...
<?php echo $__env->make('frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/user/dashboard/support-tickets/all.blade.php ENDPATH**/ ?>