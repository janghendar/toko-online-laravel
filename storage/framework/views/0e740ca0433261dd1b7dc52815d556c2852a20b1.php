        ...
        <div class="modal-content">
                        ...
                        <div class="all-uploaded-images">
                            ...
                            <div class="main-content-area-wrap">
                                ...
                                <div class="image-list-wr5apper">
                                    ...
                                    <div id="loadmorewrap">
                                        <button type="button"><?php echo e(__('LoadMore')); ?></button>
                                    </div>
                                </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary media_upload_modal_submit_btn"
                        style="display: none"><?php echo e(__('Set Image')); ?></button>
            </div>
        </div>
    </div>
</div>
<?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/partials/media-upload/media-upload-markup.blade.php ENDPATH**/ ?>