    ...
    <div class="coupon-content" <?php if(!isset(request()->coupon)): ?> style="display: none;" <?php endif; ?>>
        <div class="search-form">
            <form action="<?php echo e(route('frontend.checkout.apply.coupon')); ?>" class="discount-coupon">
                ...
                <button class="search-btn" type="submit"><?php echo filter_static_option_value('apply_coupon_btn_text', $setting_text, __('apply coupon')); ?></button>
            </form>
        </div>
    </div>
</div>
<?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/frontend/cart/partials/coupon.blade.php ENDPATH**/ ?>