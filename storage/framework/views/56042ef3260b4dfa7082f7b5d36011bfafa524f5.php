...
<?php endif; ?>
        ...
        <div class="hover-content">
            <ul class="hover-element-list">
                ...
                <?php endif; ?>
                <li><a href="#" data-id="<?php echo e($product->id); ?>" class="add_to_compare_ajax"><i
                                class="las la-random icon"></i></a></li>
                <li>
                    <?php if(isset($attributes) && $attributes > 0): ?>
                        <a class="product-quick-view-ajax" href="javascript:void(0)"
                           data-action-route="<?php echo e(route('frontend.products.single-quick-view', $product->slug)); ?>">
...
<?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/components/frontend/product/product-card-03.blade.php ENDPATH**/ ?>