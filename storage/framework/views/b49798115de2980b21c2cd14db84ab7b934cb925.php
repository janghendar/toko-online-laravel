                            ...
                            <form action="<?php echo e(route('admin.page.settings.user.auth')); ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="toc_page_link" name="toc_page_link"
                                           value="<?php echo e(get_static_option('toc_page_link')); ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="privacy_policy_link"
                                           ...
                                           value="<?php echo e(get_static_option('privacy_policy_link')); ?>">
                                </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/settings/userAuth.blade.php ENDPATH**/ ?>