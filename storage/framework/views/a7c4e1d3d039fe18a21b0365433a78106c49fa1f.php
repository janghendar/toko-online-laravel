            ...
            <div class="col-lg-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route("admin.featured.product.create")); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            <div class="form-group">
                                <label for="category">Enable Category</label>
                                <input type="checkbox" id="category" name="category" <?php echo e($selectedProduct->type == "category" ? "checked" : ""); ?>/>
                            </div>

                            <div class="form-group" id="product-list" <?php echo e($selectedProduct->type == "category" ? "style=display:none" : ""); ?>>
                                ...
                                <select id="products" name="featured_product[]" multiple class="form-control nice-select wide">
                                    ...
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(in_array($product->id,json_decode($selectedProduct->ids)) ? "selected" : ""); ?> value="<?php echo e($product->id); ?>"><?php echo e($product->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>

                            <div class="form-group"  <?php echo e($selectedProduct->type == "category" ? "" : "style=display:none"); ?> id="category-list">
                                ...
                                <select id="products" name="featured_category[]" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option <?php echo e(in_array($category->id,json_decode($selectedProduct->ids)) ? "selected" : ""); ?> value="<?php echo e($category->id); ?>"><?php echo e($category->name); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php echo $__env->make('backend.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/xgenxchi/public_html/laravel/grenmart/@core/resources/views/backend/mobile-featured-product/create.blade.php ENDPATH**/ ?>