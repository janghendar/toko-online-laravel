                        ...
                        <div class="gig-chat-message-heading">
                            ...
                            <div class="gig-order-info">
                                <ul>
                                    ...
                                    <li><strong>{{__('Status:')}}</strong> <span class="status-{{$ticket_details->status}}">{{__($ticket_details->status)}}</span>
                                    </li>
                                    <li><strong>{{__('Priority:')}}</strong> <span class="{{$ticket_details->priority}}">{{__($ticket_details->priority)}}</span>
                                    </li>
                                    <li>
