                                        ...
                                        <div id="accordion-payment">
                                                ...
                                                <div id="paystack_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="margin-bottom-30 margin-top-20 info-paragraph">
                                                            ...
                                                            <input type="text" class="info-url" value="{{route('frontend.products.paystack.ipn')}}">
                                                        </p>
                                                        <div class="form-group">
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="instamojo_settings_content" class="collapse"  data-parent="#accordion-payment">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="instamojo_auth_token">{{__('Instamojo Auth Token')}}</label>
                                                            <input type="text" name="instamojo_auth_token" id="instamojo_auth_token" value="{{get_static_option('instamojo_auth_token')}}" class="form-control">
                                                        </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="bank_transfer_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                ...
                                                                aria-expanded="false">
                                                            <span class="page-title"> {{__('Bank Transfer Settings')}}</span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="bank_transfer_settings_content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="bank_transfer_gateway"><strong>{{__('Enable/Disable Bank Transfer')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="bank_transfer_gateway"
                                                                       @if(!empty(get_static_option('bank_transfer_gateway'))) checked
                                                                       @endif id="bank_transfer_gateway">
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_logo"><strong>{{__('Bank Transfer Logo')}}</strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    @php
                                                                ...
                                                                <input type="hidden" id="bank_transfer_preview_logo"
                                                                       ...
                                                                       value="{{get_static_option('bank_transfer_preview_logo')}}">
                                                                <button type="button"
                                                                        class="btn btn-info media_upload_form_btn"
                                                                        data-btntitle="{{__('Select Image')}}"
                                                                        data-modaltitle="{{__('Upload Image')}}"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="site_bank_transfer_name">{{__('Bank Transfer Name')}}</label>
                                                            <input type="text" name="site_bank_transfer_name"
                                                                   id="site_bank_transfer_name"
                                                                   value="{{get_static_option('site_bank_transfer_name')}}"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_bank_transfer_description">{{__('Bank Transfer Description')}}</label>
                                                            <input type="hidden" name="site_bank_transfer_description" value="{{get_static_option('site_bank_transfer_description')}}">
                                                            <div class="summernote" data-content='{{get_static_option('site_bank_transfer_description')}}'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="cheque_payment_settings">
                                                    <h5 class="mb-0">
                                                        <button class="btn btn-link" type="button"
                                                                ...
                                                                aria-expanded="false">
                                                            <span class="page-title"> {{__('Cheque Payment Settings')}}</span>
                                                        </button>
                                                    </h5>
                                                </div>
                                                <div id="cheque_payment_settings_content" class="collapse"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            <label for="cheque_payment_gateway"><strong>{{__('Enable/Disable Cheque Payment')}}</strong></label>
                                                            <label class="switch">
                                                                <input type="checkbox" name="cheque_payment_gateway"
                                                                       @if(!empty(get_static_option('cheque_payment_gateway'))) checked
                                                                       @endif id="cheque_payment_gateway">
                                                                <span class="slider onff"></span>
                                                            </label>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_logo"><strong>{{__('Cheque Payment Logo')}}</strong></label>
                                                            <div class="media-upload-btn-wrapper">
                                                                <div class="img-wrap">
                                                                    @php
                                                                ...
                                                                <input type="hidden" id="cheque_payment_preview_logo"
                                                                       ...
                                                                       value="{{get_static_option('cheque_payment_preview_logo')}}">
                                                                <button type="button"
                                                                        class="btn btn-info media_upload_form_btn"
                                                                        data-btntitle="{{__('Select Image')}}"
                                                                        data-modaltitle="{{__('Upload Image')}}"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="site_cheque_payment_name">{{__('Cheque Payment Name')}}</label>
                                                            <input type="text" name="site_cheque_payment_name"
                                                                   id="site_cheque_payment_name"
                                                                   value="{{get_static_option('site_cheque_payment_name')}}"
                                                                   class="form-control">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="site_cheque_payment_description">{{__('Cheque Payment Description')}}</label>
                                                            <input type="hidden" name="site_cheque_payment_description" value="{{get_static_option('site_cheque_payment_description')}}">
                                                            <div class="summernote" data-content='{{get_static_option('site_cheque_payment_description')}}'></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
