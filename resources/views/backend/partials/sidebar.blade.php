...
{{--                    @if (auth('admin')->user()->hasRole('Super Admin'))--}}
{{--                        <li class="main_dropdown @if (request()->is(['admin-home/mobile-slider/*'])) active @endif">--}}
{{--                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>--}}
...
{{--                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>--}}
{{--                                <span>{{ __('Mobile Featured Product') }}</span></a>--}}
{{--                            <ul class="collapse">--}}
{{--                                <li class="{{ active_menu('admin-home/mobile-campaign/create') }}">--}}
{{--                                    <a href="{{ route('admin.mobile.campaign.create') }}">{{ __('Campaign Update') }}</a>--}}
{{--                                </li>--}}
...
{{--                    @if (auth('admin')->user()->hasRole('Super Admin'))--}}
{{--                        <li class="main_dropdown @if (request()->is(['admin-home/mobile-campaign/*'])) active @endif">--}}
{{--                            <a href="javascript:void(0)" aria-expanded="true"><i class="ti-user"></i>--}}
{{--                                <span>{{ __('Mobile Campaign Product') }}</span></a>--}}
{{--                            <ul class="collapse">--}}
{{--                                <li class="{{ active_menu('admin-home/mobile-campaign/create') }}">--}}
{{--                                    <a href="{{ route('admin.mobile.campaign.create') }}">{{ __('Campaign Update') }}</a>--}}
{{--                                </li>--}}
