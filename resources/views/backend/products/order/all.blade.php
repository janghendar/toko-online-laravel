...
{{--                                        <td><strong>{{ ucwords(str_replace('_', ' ', $data->payment_gateway)) }}</strong>--}}
                                        ...
                                        <td>
                                            <span class="alert @if ($data->payment_status == 'pending') alert-warning @else alert-success @endif text-capitalize">{{ $data->payment_status }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            @can('product-order-generate-invoice')
                                                <a href="{{ route('frontend.product.invoice.generate') }}" data-id="{{ $data->id }}" class="btn btn-xs btn-secondary download_invoice mb-3 mr-1" target="_blank">{{ __('Invoice') }}</a>
                                            @endcan
