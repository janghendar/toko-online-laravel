    ...
    <div class="product-thumb">
        ...
        <ul class="other-content">
            @if(!empty($campaign_percentage))
                <li>
                    <span class="badge-tag">{{ round($campaign_percentage,2) }}%</span>
                </li>
            @endif
        ...
        <ul class="other-content-2">
            ...
            @else
                <li>
                    <a href="#" data-id="{{ $product->id }}" class="favourite add_to_wishlist_ajax">
                        <i class="las la-heart icon hover"></i>
                        <i class="lar la-heart icon regular"></i>
                    </a>
                </li>
            ...
            @else
                <li>
                    <a href="javascript:void(0)" {!! getQuickViewDataMarkup($product) !!} class="favourite quick-view">
                        <i class="lar la-eye icon regular"></i>
                        <i class="lar la-eye icon hover"></i>
                    </a>
                </li>
